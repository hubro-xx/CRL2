...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    UserManage.Instance.Login(user,"user",false);//实现Form验证登录,并设定票据
        ...
        <tr><th>MSSQL</th><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>需创建分页sp_page_MSSql.sql 存储过程</td></tr>
        <tr><th>MySQL</th><td>支持</td><td>支持</td><td class="notSupported">不支持</td><td class="notSupported">不支持</td><td>支持</td><td class="notSupported">不支持</td><td>支持</td><td>需创建分页sp_page_MySql.sql 存储过程</td></tr>
        <tr><th>ORACLE</th><td>支持</td><td>支持(需高级权限)</td><td class="notSupported">不支持</td><td class="notSupported">不支持</td><td>支持</td><td class="notSupported">不支持</td><td>部份支持</td><td>需创建分页sp_page_ORACLE.sql 存储过程<br />动态执行脚本 sp_ExecuteScript_ORACLE.sql</td></tr>
        </table>
        <h5>.Net Framework 4以上</h5>
        <h5>建议配合MVC使用,面向对象开发会省很多事</h5>
    </div>
    <h4>测试数据初始</h4>
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="btn" Text="初始测试数据" />
    <br />
</asp:Content>
