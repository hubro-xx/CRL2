...
{
    public class TradeTypeManage : CRL.Category.CategoryBusiness<TradeTypeManage, TradeType>
    {
        ...
        {
            string file = System.Web.Hosting.HostingEnvironment.MapPath("/TradeType.xml");
            ExportToFile(file, b => b.Id > 0);
        }
        public void Import()
        {
            string file = System.Web.Hosting.HostingEnvironment.MapPath("/TradeType.xml");
            ImportFromFile(file, b => b.Id > 0);
        }
        /// <summary>
        /// 添加一个交易类型
